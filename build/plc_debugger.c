 ...
 * Declare programs 
 **/
extern TRAFIC_LIGHT RES0__INSTANCE0;
...
{&(RES0__INSTANCE0.O_LEDRED), BOOL_O_ENUM},
{&(RES0__INSTANCE0.O_LEDORANGE), BOOL_O_ENUM},
{&(RES0__INSTANCE0.O_LEDGREEN), BOOL_O_ENUM},
{&(RES0__INSTANCE0.FIRST_CYCLE), BOOL_O_ENUM},
...
{&(RES0__INSTANCE0._TMP_OR67_OUT), BOOL_ENUM}
};
